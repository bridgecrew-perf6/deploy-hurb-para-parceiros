    ...
    elements.visibilityControlButtons.forEach(button => {
        ...
        button.addEventListener("click", function() {
            ...
            if(button.parentNode.parentNode.classList.contains("active")) {
                ...
                button.parentNode.children[1].src = "./arrow-down-circle.svg";
            } else {
                button.parentNode.parentNode.classList.add("active");
                button.parentNode.children[1].src = "./arrow-up-circle.svg";
            }
...
$(document).ready(function() {
    ...
    var settings = {
        "url": `https://hurb-para-parceiros.herokuapp.com/api/v1/organization/${sessionStorage.getItem("organization-id")}/calendar`,
        "method": "GET",
        "timeout": 0,
        "headers": {
          "Authorization": localStorage.getItem("token"),
        ...
        if(responseObj.error) {
            ...
            for(const year in contructorObj) {
                ...
                for(const month in contructorObj[year]) {
                    ...
                    visibilityControlButton.setAttribute("src", "./arrow-down-circle.svg");
